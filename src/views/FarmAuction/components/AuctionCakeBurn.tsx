...
import { Text, Flex, Skeleton, Image } from '@iniswap/uikit'
  ...
  return (
    <Flex flexDirection={['column-reverse', null, 'row']}>
      <Flex flexDirection="column" flex="2">
        {burnedCakeAmount !== 0 ? (
          <Balance fontSize="64px" bold value={burnedCakeAmount} decimals={0} unit=" INI" />
        ) : (
      ...
      <Image width={350} height={320} src="/images/burnt-cake.png" alt={t('Burnt INI')} />
    </Flex>
  )
}
