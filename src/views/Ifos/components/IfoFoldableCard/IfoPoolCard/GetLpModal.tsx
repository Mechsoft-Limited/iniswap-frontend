...
import { Modal, ModalBody, Text, Image, Button, Link, OpenNewIcon } from '@iniswap/uikit'
    ...
    <Modal title={t('LP Tokens required')} onDismiss={onDismiss}>
      <ModalBody maxWidth="288px">
        <Image
          ...
          mb="24px"
        />
        <Text mb="16px">{t('You’ll need INI-BNB LP tokens to participate in the IFO!')}</Text>
