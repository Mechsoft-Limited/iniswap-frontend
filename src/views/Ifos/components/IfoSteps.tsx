...
import { Stepper, Step, StepStatus, Card, CardBody, Heading, Text, Button, Link, OpenNewIcon } from '@iniswap/uikit'
    ...
    switch (step) {
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t('You’ll need an active IniSwap Profile to take part in an IFO!')}
            </Text>
            {isStepValid ? (
      ...
      case 1:
        return (
          <CardBody>
            <Heading as="h4" color="secondary" mb="16px">
              {t('Get INI-BNB LP Tokens')}
            </Heading>
            <Text color="textSubtle" small>
              {t('Stake INI and BNB in the liquidity pool to get LP tokens.')} <br />
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'After the IFO sales finish, you can claim any IFO tokens that you bought, and any unspent INI-BNB LP tokens will be returned to your wallet.',
              )}
            </Text>
          </CardBody>
        )
