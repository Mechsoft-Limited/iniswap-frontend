...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and INI pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and INI pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from INI pool', data)
  }
