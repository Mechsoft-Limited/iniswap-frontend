...
import { Flex, Text, Skeleton, Link, Button, ArrowForwardIcon } from '@iniswap/uikit'
...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in INI prizes this round', { cakePrizeInUsd: cakePriceBusdAsString })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with INI, win INI if your numbers match')}
        </Text>
      </Flex>
