...
import { Card, CardBody, Heading, Text } from '@iniswap/uikit'
      ...
      <Card mb="24px">
        <CardBody>
          ...
          <Text as="p" mb="24px" color="textSubtle">
            {t('Cost: %num% INI', { num: formatUnits(MINT_COST) })}
          </Text>
          {nfts.map((nft) => {
          ...
          {!hasMinimumCakeRequired && (
            <Text color="failure" mb="16px">
              {t('A minimum of %num% INI is required', { num: formatUnits(MINT_COST) })}
            </Text>
          )}
