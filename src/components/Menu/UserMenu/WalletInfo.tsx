...
import { Box, Button, Flex, InjectedModalProps, LinkExternal, Message, Skeleton, Text } from '@iniswap/uikit'
...
const WalletInfo: React.FC<WalletInfoProps> = ({ hasLowBnbBalance, onDismiss }) => {
  ...
  const { balance: cakeBalance, fetchStatus: cakeFetchStatus } = useTokenBalance(tokens.ini.address)
  ...
  return (
    <>
      ...
      <Flex alignItems="center" justifyContent="space-between" mb="24px">
        <Text color="textSubtle">{t('INI Balance')}</Text>
